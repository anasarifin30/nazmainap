...
<head>
    ...
    @vite(['resources/css/owner/homestay/addaddress.css'])
                ...
                <div class="form-content">
                    ...
                    <form class="homestay-form">
                        ...
                        <div class="form-actions">
                            <a href="/owner/1" class="btn btn-secondary">Kembali</a>
                            <a href="/owner/addphoto" class="btn btn-primary">Lanjutkan</a>
                        </div>
                    </form>
                </div>
            </div>
